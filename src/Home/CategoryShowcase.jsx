       ...
       <div className='container'>
          <div className='section-header'>
           ...
           <div className='section-wrapper'>
              <div className='row g-4 justify-content-center row-cols-xl-4 row-cols-lg-3 row-cols-md-3 row-cols-1 course-filter'>
                    {
                      items.map((products) => <div key={products.id} className='col'>
                                    ...
                                    <div className='course-content'>
                                         ...
                                         <div className='course-footer'>
                                            <div className='course-author'>
                                               <Link to="/" className='ca-name'>{products.brand}</Link>
                                            </div>
