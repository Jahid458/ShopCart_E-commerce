...
const addressList = [
  { iconName: "icofont-google-map", text: " 85/A Gulshan-2,Dhaka-1212" },
  { iconName: "icofont-phone", text: " +880 123789456" },
        ...
        <div className="footer-bottom">
            <div className="container">
                <div className="section-wrapper">
                    <p>&copy; 2024 <Link to="/">Shop Cart</Link>Deasigned By <a href="/" target="_blank">Md.Jahidul Islam</a></p>
